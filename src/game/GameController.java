...
public class GameController {
    ...
    private void transitionTo(Door door) {
        ...
        if (mirror != null) {
            ...
            int distLeft = origenRoom != null ? Math.abs(doorCenterX) : Integer.MAX_VALUE;
            int distRight = origenRoom != null ? Math.abs(doorCenterX - origenRoom.width) : Integer.MAX_VALUE;
            int distTop = origenRoom != null ? Math.abs(doorCenterY) : Integer.MAX_VALUE;
